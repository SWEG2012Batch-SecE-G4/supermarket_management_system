...
void S_howMany()
{
	cout<<"\n\t-------------------------------------------------\n";
	cout<<"\t---------------------------------------------------\n";
	cout<<"\n\tEnter number of items to be solled: ";
}
...
stat:
		...
		case 1:
            ...
            case 1:
				...
				cout<<"	-------------------------------------------------\n\n";
                cout<<" ------------------------------------------------------------------------------------------\n";
                cout<<"|"<<setw(15)<<"Name"<<setw(15)<<"|"<<setw(10)<<"Cost(birr)"<<setw(5)<<"|"<<setw(5)<<"Price(birr)"<<setw(5)<<"|"<<setw(5)<<"Profit(birr)"<<setw(5)<<"|"<<setw(5)<<"Quantity"<<setw(5)<<"|"<<endl;
                cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   for(int i=0; i<NewF; i++)
                   {
                       	cout<<"|"<<food[i].name<<setw(25)<<"|"<<food[i].cost<<setw(14)<<"|"<<food[i].price<<setw(15)<<"|"<<food[i].profit<<setw(16)<<"|"<<food[i].amount<<setw(12)<<"|"<<endl;
                   		cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   }
			menu();
				cin>>choice;
		    ...
		    case 2:
                ...
                cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   for(int i=0; i<NewF; i++)
                   {
                       	cout<<"|"<<beverage[i].name<<setw(25)<<"|"<<beverage[i].cost<<setw(14)<<"|"<<beverage[i].price<<setw(15)<<"|"<<beverage[i].profit<<setw(16)<<"|"<<beverage[i].amount<<setw(12)<<"|"<<endl;
                   		cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
                    }
            menu();
				cin>>choice;
            ...
            case 3:
                ...
                cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   for(int i=0; i<NewF; i++)
                   {
                       	cout<<"|"<<personalCare[i].name<<setw(25)<<"|"<<personalCare[i].cost<<setw(14)<<"|"<<personalCare[i].price<<setw(15)<<"|"<<personalCare[i].profit<<setw(16)<<"|"<<personalCare[i].amount<<setw(12)<<"|"<<endl;
                   		cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   }
			menu();
				cin>>choice;
            ...
            case 4:
                ...
                cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   for(int i=0; i<NewF; i++)
                   {
                       	cout<<"|"<<household_suplly[i].name<<setw(25)<<"|"<<household_suplly[i].cost<<setw(14)<<"|"<<household_suplly[i].price<<setw(15)<<"|"<<household_suplly[i].profit<<setw(16)<<"|"<<household_suplly[i].amount<<setw(12)<<"|"<<endl;
                   		cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   }
			menu();
				cin>>choice;
            ...
            case 5:
                ...
                cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   for(int i=0; i<NewF; i++)
                   {
                       	cout<<"|"<<others[i].name<<setw(25)<<"|"<<others[i].cost<<setw(14)<<"|"<<others[i].price<<setw(15)<<"|"<<others[i].profit<<setw(16)<<"|"<<others[i].amount<<setw(12)<<"|"<<endl;
                   		cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   }
			menu();
				cin>>choice;
		...
		case 2:
            ...
            case 1:
                ...
                cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   for(int i=0; i<NewF; i++)
                   {
                       	cout<<"|"<<S_food[i].name<<setw(25)<<"|"<<S_food[i].cost<<setw(14)<<"|"<<S_food[i].price<<setw(15)<<"|"<<S_food[i].profit<<setw(16)<<"|"<<S_food[i].amount<<setw(12)<<"|"<<endl;
                   		cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   }
			menu();
				cin>>choice;
            ...
            case 2:
                ...
                cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   for(int i=0; i<NewF; i++)
                   {
                       	cout<<"|"<<S_beverage[i].name<<setw(25)<<"|"<<S_beverage[i].cost<<setw(14)<<"|"<<S_beverage[i].price<<setw(15)<<"|"<<S_beverage[i].profit<<setw(16)<<"|"<<S_beverage[i].amount<<setw(12)<<"|"<<endl;
                   		cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   }
			menu();
				cin>>choice;
            ...
            case 3:
                ...
                cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   for(int i=0; i<NewF; i++)
                   {
                       	cout<<"|"<<S_personalCare[i].name<<setw(25)<<"|"<<S_personalCare[i].cost<<setw(14)<<"|"<<S_personalCare[i].price<<setw(15)<<"|"<<S_personalCare[i].profit<<setw(16)<<"|"<<S_personalCare[i].amount<<setw(12)<<"|"<<endl;
                   		cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   }
			menu();
				cin>>choice;
            ...
            case 4:
                ...
                cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   for(int i=0; i<NewF; i++)
                   {
                       	cout<<"|"<<S_household_suplly[i].name<<setw(25)<<"|"<<S_household_suplly[i].cost<<setw(14)<<"|"<<S_household_suplly[i].price<<setw(15)<<"|"<<S_household_suplly[i].profit<<setw(16)<<"|"<<S_household_suplly[i].amount<<setw(12)<<"|"<<endl;
                   		cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   }
			menu();
				cin>>choice;
            ...
            case 5:
                ...
                cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   for(int i=0; i<NewF; i++)
                   {
                       	cout<<"|"<<S_others[i].name<<setw(25)<<"|"<<S_others[i].cost<<setw(14)<<"|"<<S_others[i].price<<setw(15)<<"|"<<S_others[i].profit<<setw(16)<<"|"<<S_others[i].amount<<setw(12)<<"|"<<endl;
                   		cout<<"|-----------------------------|--------------|---------------|----------------|------------|\n";
				   }
			menu();
				cin>>choice;
